...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            // Allow public endpoints if any, e.g., order creation could be protected, so adjust as per need
            if (path.equals("/order/login") || (path.equals("/order") && request.getMethod().equalsIgnoreCase("POST"))) {
